    ...
    try {
        ...
        if (user.email) {
            const mailInfo = await sendMail({
                ...
                <p>Please change your password after logging in for the first time. <strong><a href={'${process.env.NEXT_PUBLIC_BASE_APP_BASE_URL}/auth/login'}>Click Here</a></strong> to login</p>`,
